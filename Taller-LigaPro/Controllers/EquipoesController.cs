...
namespace Taller_LigaPro.Controllers
{
    public class EquipoesController : Controller
    {
        ...
        public EquipoesController(Taller_LigaProContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,PartidosGanados,PartidosEmpatados,PartidosPerdidos,LogoUrl")] Equipo equipo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,PartidosGanados,PartidosEmpatados,PartidosPerdidos,LogoUrl")] Equipo equipo)
        {
            if (id != equipo.Id)
            {
                return NotFound();
